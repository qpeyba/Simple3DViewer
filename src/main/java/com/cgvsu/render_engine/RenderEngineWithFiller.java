...
public class RenderEngineWithFiller {
            ...
            final int height)
    {
        ...
        for (int polygonInd = 0; polygonInd < nPolygons; ++polygonInd) {
            ...
            Point2f resultPoint1 = vertexToPoint(multiplyMatrix4ByVector3(modelViewProjectionMatrix, vertexVecmath1), width, height);
            Point2f resultPoint2 = vertexToPoint(multiplyMatrix4ByVector3(modelViewProjectionMatrix, vertexVecmath2), width, height);
            Point2f resultPoint3 = vertexToPoint(multiplyMatrix4ByVector3(modelViewProjectionMatrix, vertexVecmath3), width, height);
